...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentExampleEditorJs = __webpack_require__(1);

	var _componentExampleEditorJs2 = _interopRequireDefault(_componentExampleEditorJs);

	var _srcIndexJs = __webpack_require__(33);

	var _srcIndexJs2 = _interopRequireDefault(_srcIndexJs);

	window.ExampleEditor = _componentExampleEditorJs2['default'];

	var editors = [].slice.call(document.querySelectorAll('.j-editor'));

	editors.forEach(function (editor) {
	  new _componentExampleEditorJs2['default']({
	    data: {
	      source: editor.value
	    }
	  }).$inject(editor, 'after');
	  _srcIndexJs2['default'].dom.remove(editor);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _codemirror = __webpack_require__(31);

	var _codemirror2 = _interopRequireDefault(_codemirror);

	var _codemirrorModeJavascriptJavascriptJs = __webpack_require__(32);

	var _codemirrorModeJavascriptJavascriptJs2 = _interopRequireDefault(_codemirrorModeJavascriptJavascriptJs);
	...
	exports['default'] = _regularjs2['default'].extend({
	  ...
	  config: function config(data) {
	    ...
	    this.$watch('!!open', function (open) {
	      if (open) {
	        this.editor = _codemirror2['default'].fromTextArea(this.$refs.area, {
	          mode: data.mode,
	          lineNumbers: false,
	          lineWrapping: false,
	          matchBrackets: true,
	  ...
	  changeContent: function changeContent(content) {
	    ...
	    try {
	      ...
	      this.data.component = new Function('Regular', code + ';return component;')(_regularjs2['default']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (env.browser) {
	  ...
	  Regular.dom = __webpack_require__(10);
	}
	Regular.env = env;
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	var Regular = function Regular(options) {
	...
	Regular.implement({
	  ...
	  _sg_: function _sg_(path, defaults, ext) {
	    if (typeof ext !== 'undefined') {
	      ...
	      if (computedProperty) {
	        ...
	        if (computedProperty.get) return computedProperty.get(this);else _.log("the computed '" + path + "' don't define the get function,  get data." + path + " altnately", "error");
	      }
	    }
	  ...
	  _ss_: function _ss_(path, value, data, op, computed) {
	    ...
	    if (computedProperty) {
	      if (computedProperty.set) return computedProperty.set(this, value);else _.log("the computed '" + path + "' don't define the set function,  assign data." + path + " altnately", "error");
	    }
	    data[path] = value;
	    return value;
	  }
	...
	walkers.component = function (ast, options) {
	  ...
	  for (var i = 0, len = attrs.length; i < len; i++) {
	    ...
	    if (value.type === 'expression' && !attr.event) {
	      ...
	      if (!(isolate & 2)) this.$watch(value, component.$update.bind(component, name));
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";(function(mod){if(true) // CommonJS
	...
	function ContentEditableInput(cm){this.cm = cm;this.lastAnchorNode = this.lastAnchorOffset = this.lastFocusNode = this.lastFocusOffset = null;this.polling = new Delayed();this.gracePeriod = false;}ContentEditableInput.prototype = copyObj({init:function init(display){var input=this,cm=input.cm;var div=input.div = display.lineDiv;div.contentEditable = "true";disableBrowserMagic(div);on(div,"paste",function(e){handlePaste(e,cm);});on(div,"compositionstart",function(e){var data=e.data;input.composing = {sel:cm.doc.sel,data:data,startData:data};if(!data)return;var prim=cm.doc.sel.primary();var line=cm.getLine(prim.head.line);var found=line.indexOf(data,Math.max(0,prim.head.ch - data.length));if(found > -1 && found <= prim.head.ch)input.composing.sel = simpleSelection(Pos(prim.head.line,found),Pos(prim.head.line,found + data.length));});on(div,"compositionupdate",function(e){input.composing.data = e.data;});on(div,"compositionend",function(e){var ours=input.composing;if(!ours)return;if(e.data != ours.startData && !/\u200b/.test(e.data))ours.data = e.data; // Need a small delay to prevent other code (input event,
	...
	CodeMirror.version = "5.5.0";return CodeMirror;}); // at http://marijnhaverbeke.nl/blog/#cm-internals .
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (mod) {
	  if (true) // CommonJS
	    mod(__webpack_require__(31));else if (typeof define == "function" && define.amd) // AMD
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SelectItem = __webpack_require__(39);

	var _SelectItem2 = _interopRequireDefault(_SelectItem);

	var _Pophover = __webpack_require__(40);
	...
	var _Mask = __webpack_require__(46);

	var _Mask2 = _interopRequireDefault(_Mask);

	var _utilUtil = __webpack_require__(36);

	var _utilUtil2 = _interopRequireDefault(_utilUtil);

	var _utilDom = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilEvents = __webpack_require__(43);
